...
urlpatterns = [
    ...
    path('PartyNames',views.PartyNames,name="Party Name"),
    ...
    path('LocationCode',views.LocationCode,name='LocationCode'),
    ...
    path('ProfileMK',views.ProfileMK,name='Profile'),
    path('PWChange',views.PWChange,name='PWChange'),
    path('InvoiceDelete/<int:id>',views.InvoiceDelete,name='InvoiceDelete'),
    path('WInvoice',views.WInvoice,name="WInvoice"),
    path('AddWInvoice',views.AddWInvoice,name="Add Workorder Invoice"),
    path('AddWInvoiceMaIN',views.AddWInvoiceMaIN,name="Add Workorder Invoice Main Form"),
    path('WInvoiceDelete/<int:id>',views.WInvoiceDelete,name='WInvoiceDelete'),
